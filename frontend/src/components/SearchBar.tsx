...
const SearchBar = () => {
  ...
  return (
    <form
      ...
      className="-mt-8 p-3 bg-dark-pink rounded-lg shadow-md grid grid-cols-2 lg-gris-cols-3 2xl:grid-cols-5 items-center gap-4"
    >
      ...
      <div className="flex gap-1">
        <button className="w-1/3 bg-dark-pink text-white h-full p-2 font-semibold text-xl hover:bg-pink rounded">
          Clear
        </button>
